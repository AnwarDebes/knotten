...
- Every estimate on every page remains labelled an *indikativt estimat*, sourced and carrying *"ikke profesjonell rådgivning"*; SEO and structured data never restate an estimate as fact.
