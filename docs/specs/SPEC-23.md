...
- Honesty: any indicative figure in surrounding copy stays labelled an *indikativt estimat*, sourced and disclaimed; security docs state real posture, not aspiration.
