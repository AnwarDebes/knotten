...
- Each output shows its assumptions, the source, and the _indikativt estimat_ disclaimer. Results are deterministic and reproducible from the inputs alone.
...
- [ ] The _"indikativt estimat, ikke en garanti, endelige tall krever profesjonell energimodellering"_ disclaimer is present.
...
- Every estimate is labelled _indikativt estimat_, sourced (PVGIS, NS 3700, TEK17, SSB), and disclaimed as not financial or engineering advice.
