...
- Honesty: every value labelled _illustrativ simulering_ / _indikativt estimat_, sourced (PVGIS, SSB, scheme rules) and disclaimed; simulated data is never shown as live telemetry.
